...
### Fixed
* Getting `Backlink` properties of unmanaged Realm objects will throw exception: "Using backlinks is only possible for managed objects." ([#1293](https://github.com/realm/realm-dart/pull/1293)).
