...
* Support creating application configuration ([#306](https://github.com/realm/realm-dart/pull/306/))
* Support creating application ([#446](https://github.com/realm/realm-dart/pull/446/))
