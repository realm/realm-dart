...
* If `syncErrorHandler` occurs with a new unknown error code then return `SyncSessionErrorCode.unknown`, `SyncConnectionErrorCode.unknown`, `SyncClientErrorCode.unknown` or `GeneralSyncErrorCode.unknown` instead of throwing exception.
