...
Future<void> main([List<String>? args]) async {
  ...
  baasTest('Realm open async - open twice the same realm and cancel the first only', (appConfiguration) async {
    ...
    final validFuture = Future<void>.delayed(Duration(milliseconds: 200), () async {
  ...
  baasTest('Realm open async with added data and get progress', (appConfiguration) async {
    final app = App(appConfiguration);
...
Future<Configuration> addDataToAtlas(App app) async {
