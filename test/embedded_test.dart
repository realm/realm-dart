...
Future<void> main([List<String>? args]) async {
  ...
  test('local Realm with orphan embedded schemas works', () {
    ...
    expect(schema.single.modelType, RealmModelType.embedded);
  });
  ...
  for (final isDynamic in [true, false]) {
    ...
    //   expect(child11.instanceSchema.baseType, RealmModelType.embedded);
    ...
    //   expect(list1[0].instanceSchema.baseType, RealmModelType.embedded);
    ...
    //   expect(child21.instanceSchema.baseType, RealmModelType.embedded);
    ...
    //   expect(list2[0].instanceSchema.baseType, RealmModelType.embedded);
    ...
    //   expect(child31.instanceSchema.baseType, RealmModelType.embedded);
