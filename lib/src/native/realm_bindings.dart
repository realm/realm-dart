...
abstract class realm_errno {
  ...
  static const int RLM_ERR_WEBSOCKET_RESERVED = 4403;
  static const int RLM_ERR_WEBSOCKET_NOSTATUSRECEIVED = 4404;
  static const int RLM_ERR_WEBSOCKET_ABNORMALCLOSURE = 4405;
  static const int RLM_ERR_WEBSOCKET_INVALIDPAYLOADDATA = 4406;
  static const int RLM_ERR_WEBSOCKET_POLICYVIOLATION = 4407;
  static const int RLM_ERR_WEBSOCKET_MESSAGETOOBIG = 4408;
  static const int RLM_ERR_WEBSOCKET_INAVALIDEXTENSION = 4409;
  static const int RLM_ERR_WEBSOCKET_INTERNALSERVERERROR = 4410;
  static const int RLM_ERR_WEBSOCKET_TLSHANDSHAKEFAILED = 4411;
