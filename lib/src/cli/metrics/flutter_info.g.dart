...
FlutterInfo _$FlutterInfoFromJson(Map<String, dynamic> json) => FlutterInfo(
      frameworkVersion:
          const VersionConverter().fromJson(json['frameworkVersion'] as String),
      ...
      dartSdkVersion:
          const VersionConverter().fromJson(json['dartSdkVersion'] as String),
...
Map<String, dynamic> _$FlutterInfoToJson(FlutterInfo instance) =>
    <String, dynamic>{
      'frameworkVersion':
          const VersionConverter().toJson(instance.frameworkVersion),
