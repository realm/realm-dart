...
Properties _$PropertiesFromJson(Map<String, dynamic> json) => Properties(
  ...
  anonymizedBundleId: const DigestConverter().fromJson(
    json['Anonymized Bundle ID'] as String?,
  ),
  anonymizedMacAddress: const DigestConverter().fromJson(
    json['Anonymized MAC Address'] as String?,
  ),
  syncEnabled: json['Sync Enabled'] as String?,
  targetOsType: $enumDecodeNullable(
    _$TargetOsTypeEnumMap,
    json['Target OS Type'],
  ),
...
Map<String, dynamic> _$PropertiesToJson(Properties instance) =>
    <String, dynamic>{
      ...
      'Anonymized MAC Address': ?const DigestConverter().toJson(
        instance.anonymizedMacAddress,
      ),
      'Anonymized Bundle ID': ?const DigestConverter().toJson(
        instance.anonymizedBundleId,
      ),
      ...
      'Target OS Type': ?_$TargetOsTypeEnumMap[instance.targetOsType],
      'Target OS Version': ?instance.targetOsVersion,
      'Core Version': ?instance.realmCoreVersion,
    };
